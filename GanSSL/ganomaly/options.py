...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--name', type=str, default='GANSSL', help='name of the experiment')
        ...
        self.parser.add_argument('--outf', default='/home/wangyl/data_wyl/MAGAD/Ablation', help='folder to output images and model checkpoints')
