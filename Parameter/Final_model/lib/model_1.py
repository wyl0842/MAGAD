# -*- coding: utf-8 -*-
"""
Created on Fri Aug  7 14:16:16 2020
...
from lib.cnn import NetD, weights_init,Connection,Sia
...
class BaseModel():
    ...
    def test_1(self):
        ...
        if True:
            ...
            path = "./output/{}/{}/case/netG_119.pth".format(self.name.lower(), self.opt.dataset)
            pretrained_dict = torch.load(path)['state_dict']
            
            path_d = "./output/{}/{}/case/netD_119.pth".format(self.name.lower(), self.opt.dataset)
    ...
    def test_3(self):
        ...
        with torch.no_grad():
            ...
            for i, data in enumerate(self.dataloader['test'], 0):
                ...
                error = 10*torch.mean(torch.pow((latent_i-latent_o), 2), dim=1)+error1
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            for i, data in enumerate(self.dataloader['test'], 0):
                ...
                time_i = time.time()
                self.set_input(data)
                error, feature = self.netd(self.input)
                time_o = time.time()
...
class Ganomaly(BaseModel):
    ...
    def backward_d(self):
        ...
        """
        # Real - Fake Loss
        self.err_d_real = self.l_bce(self.pred_real, self.gt)
