...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='tire', help='folder | cifar10 | mnist ')
        self.parser.add_argument('--dataroot', default='/home/wangyl/data_wyl/Reconstruction/new_Dataset', help='path to dataset')
        ...
        self.parser.add_argument('--name', type=str, default='Ganomaly1024', help='name of the experiment')
        ...
        self.parser.add_argument('--outf', default='/home/wangyl/data_wyl/Reconstruction/Output/GAN', help='folder to output images and model checkpoints')
