...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--name', type=str, default='ganomaly_ssl', help='name of the experiment')
        ...
        self.parser.add_argument('--outf', default='/home/wangyl/data_wyl/Reconstruction/Output/Nov_GAN', help='folder to output images and model checkpoints')
